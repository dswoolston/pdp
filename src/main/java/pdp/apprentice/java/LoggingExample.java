...
public class LoggingExample {
  ...
  private static final Logger SLF4J_LOGGER = LoggerFactory.getLogger(LoggingExample.class);
  ...
  public static void main(String[] args) {
    ...
    SLF4J_LOGGER
      .info("timestamp=\"{}\" hostname=\"{}\" ip=\"{}\" message=\"{}\"", new Date(), descriptor.getHostName(), descriptor.getIpAddress(), "my info message");
    SLF4J_LOGGER
      .debug("timestamp=\"{}\" hostname=\"{}\" ip=\"{}\" message=\"{}\"", new Date(), descriptor.getHostName(), descriptor.getIpAddress(), "my debug message");
  }
